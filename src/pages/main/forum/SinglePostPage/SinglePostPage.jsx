    ...
    useEffect(() => {
        const fetchPost = async () => {
            try {
                ...
                setPost(data.data); // Nếu API trả về { code, message, data }
            } catch (err) {
            ...
            <div className="container mx-auto grid grid-cols-1 lg:grid-cols-11 gap-6 relative z-10">
                ...
                <div className="col-span-10 lg:col-span-8 bg-white dark:bg-[#1e1e2f] rounded-xl shadow p-6 ml-10">
                    ...
                    <div className="flex items-center mb-4">
                        <img
                            src={post.userAvatar || "https://api.dicebear.com/7.x/miniavs/svg?seed=1"}
...
<p className="text-xs text-gray-400">
    Đăng lúc {new Date(post.createAt).toLocaleString("vi-VN", {
        day: "2-digit",
        month: "2-digit",
        year: "numeric",
        hour: "2-digit",
