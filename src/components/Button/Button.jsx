...
const Button = ({ children, className, onClick }) => {
    return (
        <button
            className={`flex justify-center gap-2 items-center mx-auto shadow-xl  text-black-50  backdrop-blur-md lg:font-semibold border-gray-50 border-2 rounded-full overflow-hidden group z-10
      ...
      hover:text-gray-50 hover:before:left-0 hover:before:scale-150 hover:cursor-pointer ${className}`}
        ...
        >
            {children}
            <svg
                className="w-8 h-8 justify-end text-gray-50 ease-linear duration-300 rounded-full border border-gray-700 p-2 rotate-45
